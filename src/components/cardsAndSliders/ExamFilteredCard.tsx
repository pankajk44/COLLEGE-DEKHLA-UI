      ...
      <div className="relative mb-5 w-full rounded-lg shadow-lg bg-white">
        <div className="flex gap-y-2 p-5 max-lg:flex-wrap">
          <Image
            ...
            width={220}
            height={175}
            className="h-[175px] w-[220px] rounded-md max-lg:w-full object-cover"
          />
            ...
            <div className="mb-3 flex flex-wrap gap-x-6">
                ...
                <div className="flex gap-x-2">
                  ...
                  <div>
                    <p className="font-semibold">
                      Registration Date:{" "}
                      <span className="text-zinc-600">{exam.applicationSubmissionDates.startDate}</span>
                    </p>
                  </div>
                </div>
              </div>
              <div className="flex flex-col">
                <div className="flex gap-x-2">
                  ...
                  <div>
                    <p className="font-semibold">
                      Exam Date: <span className="text-zinc-600">{exam.applicationSubmissionDates.endDate}</span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mb-3 flex flex-wrap gap-x-6">
              <div className="flex flex-col">
                <div className="flex gap-x-2">
                  ...
                  <div>
                    <p className="font-semibold text-blue-500">{exam.mode}</p>
                  </div>
                </div>
              </div>
              <div className="flex flex-col">
                <div className="flex gap-x-2">
                  ...
                  <p className="font-semibold text-blue-500">{exam.ExaminationLevel}</p>
                </div>
              </div>
            </div>
            <div className="flex gap-x-1 text-zinc-600">
              <p className="line-clamp-2 text-wrap text-sm [flex:11]">
                <span className="line-clamp-2 text-justify">{exam.description}</span>
